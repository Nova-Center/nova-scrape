...
public class ApplicationController implements Initializable {
    ...
    private List<NovaScrapePlugin> plugins;
    ...
    public ApplicationController(Stage stage, List<NovaScrapePlugin> plugins) {
        this.stage = stage;
    ...
    public void initializeLoader() {
        ...
        for(NovaScrapePlugin plugin : plugins) {
            loader.addView(MFXLoaderBean.of(plugin.getViewName(), plugin.getFxmlPath()).setBeanToNodeMapper(() -> createToggle(plugin.getIcon(), plugin.getName())).setControllerFactory(c -> plugin.createController(stage)).get());
        }
